...
# the carrying line grows notes over time (ABLE lists, rods, stones), so
# this asks only that the gift note is still on it (2026-09-10)
ck("the carrying line asks for it",
   "{self._disp_item(k)} x{v}{self._gift_note(k)}" in src)   # TMs print by number (2026-09-07)
